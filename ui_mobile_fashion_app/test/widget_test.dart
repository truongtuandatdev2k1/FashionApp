...
// Fix: Import main_customer.dart thay main.dart
import 'package:ui_mobile_fashion_app/customer/views/splash/customer_splash_screen.dart'; // Import splash để test

void main() {
  testWidgets('Customer Splash Screen displays welcome text', (
    WidgetTester tester,
  ) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(
      const MaterialApp(
        // Wrap trong MaterialApp để test widget độc lập
    ...
    expect(
      find.text('Welcome to Customer App'),
      findsOneWidget,
    ); // Fix: Test text thực tế
